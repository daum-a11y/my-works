...
union all
select 'members.public_count', count(*)::text from public.members where legacy_user_num is not null
union all
...
left join legacy_xref.members x on x.legacy_user_num = s.user_num
