...
describe("ReportsPage", () => {
  it("renders the input tabs, today summary, and date search table", async () => {
    ...
    mockUseReportsSlice.mockReturnValue({
      ...
      draftPages: [
        { id: "page-1", projectId: "project-1", title: "메인", url: "https://example.com", ownerMemberId: null, trackStatus: "미개선", monitoringInProgress: false, qaInProgress: false, note: "", updatedAt: "2026-03-24T00:00:00.000Z" },
      ],
      taskTypes: [
        { id: "type-1", legacyTypeId: "1", type1: "기획", type2: "작성", label: "기획 / 작성", displayOrder: 1 },
      ],
      type1Options: ["기획"],
      type2Options: ["작성"],
    ...
    expect(screen.getByText("60분 사용 했습니다. 오늘의 남은시간은 420분 입니다.")).toBeInTheDocument();
