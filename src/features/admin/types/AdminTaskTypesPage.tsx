...
export function AdminTaskTypesPage() {
  ...
  const type1Options = useMemo(
    () => groupedTaskTypes.map((group) => group.type1),
    [groupedTaskTypes],
  );
  ...
  const handleChange = <K extends keyof AdminTaskTypePayload>(
    key: K,
    value: AdminTaskTypePayload[K],
  ) => {
                ...
                <tr>
                  ...
                  <td className={styles.inlineRowCell}>
                    <select
                      ...
                      onChange={(event) =>
                        handleChange('requiresServiceGroup', event.target.value === '1')
                      }
                    >
                      ...
                      <tr key={item.id}>
                        ...
                        <td className={styles.inlineRowCell}>
                          <select
                            ...
                            onChange={(event) =>
                              handleChange('isActive', event.target.value === '1')
                            }
                          >
