...
def build_dump():
    ...
    for row in service_groups:
        ...
        group = {
            ...
            "service_group_name": raw_service_group,
    ...
    for row in pages:
        ...
        page = {
            ...
            "title": title,
            "url": url,
            "task_month": blank_to_none(row["pj_page_date"]),
            "task_status": "전체 수정" if track_end == 1 else "일부 수정" if track_end == 2 else "미수정",
